...
function getMonthlyData() {
  ...
  var queryUrl = `https://www.quandl.com/api/v3/datasets/WIKI/AAPL.json?start_date=2016-10-01&end_date=2017-10-01&collapse=monthly&api_key=${apiKey}`;
...
function buildPlot() {
  var url = `https://www.quandl.com/api/v3/datasets/WIKI/AAPL.json?start_date=2016-10-01&end_date=2017-10-01&api_key=${apiKey}`;
